...
public class f extends a {
    ...
    public final ListView f3439u;

    public f(ListView listView) {
        super(listView);
        this.f3439u = listView;
    }
    ...
    public boolean b(int r8) {
        /*
            r7 = this;
            android.widget.ListView r0 = r7.f3439u
            int r1 = r0.getCount()
            r2 = 0
        ...
        L_0x0039:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.f.b(int):boolean");
    }

    public void j(int i4, int i5) {
        this.f3439u.scrollListBy(i5);
    }
}

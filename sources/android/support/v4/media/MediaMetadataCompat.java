...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final C0944a f4025f;

    /* renamed from: g  reason: collision with root package name */
    public static final String[] f4026g = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};

    /* renamed from: h  reason: collision with root package name */
    public static final String[] f4027h = {"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};

    /* renamed from: i  reason: collision with root package name */
    public static final String[] f4028i = {"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
    ...
    public MediaMetadataCompat(Parcel parcel) {
        this.f4029e = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
